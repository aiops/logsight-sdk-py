...
class TestAppManagement(unittest.TestCase):
    ...
    def test_create_delete_app(self):
        ...
        status_code, content = self.create_app(app_name)
        self.delete_app(str(content['id']))
    ...
    def test_create_duplicate(self):
        app_name = 'test_create_app'
        _, content = self.create_app(app_name)
    ...
    def test_create_list_delete_apps(self):
        ...
        app_ids = [self.create_app(app_name)[1]['id'] for app_name in app_names]
