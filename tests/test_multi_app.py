...
N_LOG_MESSAGES_TO_SEND = 5
MAP_APP_NAME_LOG_FILE = [('hadoop', N_LOG_MESSAGES_TO_SEND, 'hadoop'),
                         ('openstack', N_LOG_MESSAGES_TO_SEND, 'openstack'),
                         ('mac', N_LOG_MESSAGES_TO_SEND, 'mac')]
...
class TestMultiApp(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        def send_log_messages(log_file_id, n_log_messages_to_send, app_name):
